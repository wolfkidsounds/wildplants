...
public final class WildplantsConfig {
    ...
    static {
        ...
        GLOBAL_PATCH_SIZE = BUILDER
                .comment("How many plants are placed in a patch at maximum (higher is more) [Default: 6]")
                .define("Size", 3);
        GLOBAL_SPREAD_SIZE = BUILDER
                .comment("How far apart the plants are at maximum (higher is more far) [Default: 2]")
                .define("Spread", 50);
        BUILDER.pop();
        BUILDER.push("Compat");
