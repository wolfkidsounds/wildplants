...
public class VeggieWayConfig {
    ...
    static {
        ...
        CHANCE_VEGGIEWAY_WILD_CORN = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 0, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("VEGGIEWAY WILD LENTIL");
        GENERATE_VEGGIEWAY_WILD_LENTIL = BUILDER.define("Enabled:", true);
        CHANCE_VEGGIEWAY_WILD_LENTIL = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 0, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("VEGGIEWAY WILD QUINOA");
        GENERATE_VEGGIEWAY_WILD_QUINOA = BUILDER.define("Enabled:", true);
        CHANCE_VEGGIEWAY_WILD_QUINOA = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 5, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("VEGGIEWAY WILD SOYBEAN");
        GENERATE_VEGGIEWAY_WILD_SOYBEAN = BUILDER.define("Enabled:", true);
        CHANCE_VEGGIEWAY_WILD_SOYBEAN = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 5, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("VEGGIEWAY WILD COTTON");
        GENERATE_VEGGIEWAY_WILD_COTTON = BUILDER.define("Enabled:", true);
        CHANCE_VEGGIEWAY_WILD_COTTON = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 5, Integer.MAX_VALUE);
        BUILDER.pop();
