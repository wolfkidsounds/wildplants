...
public class MinecraftConfig {
    ...
    static {
        ...
        GENERATE_MINECRAFT_WILD_WHEAT = BUILDER.define("Enabled:", true);
        CHANCE_MINECRAFT_WILD_WHEAT = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 0, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("MINECRAFT WILD CARROTS");
        GENERATE_MINECRAFT_WILD_CARROTS = BUILDER.define("Enabled:", true);
        CHANCE_MINECRAFT_WILD_CARROTS = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 0, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("MINECRAFT WILD POTATOES");
        GENERATE_MINECRAFT_WILD_POTATOES = BUILDER.define("Enabled:", true);
        CHANCE_MINECRAFT_WILD_POTATOES = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 5, Integer.MAX_VALUE);
        BUILDER.pop();

        BUILDER.push("MINECRAFT WILD BEETROOTS");
        GENERATE_MINECRAFT_WILD_BEETROOTS = BUILDER.define("Enabled:", true);
        CHANCE_MINECRAFT_WILD_BEETROOTS = BUILDER.comment("SMALLER=MORE - Default [64]").defineInRange("Chance:", 265, 5, Integer.MAX_VALUE);
        BUILDER.pop();
