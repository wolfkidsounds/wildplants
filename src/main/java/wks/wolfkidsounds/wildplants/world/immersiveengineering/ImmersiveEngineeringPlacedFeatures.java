...
public class ImmersiveEngineeringPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> IMMERSIVEENGINEERING_WILD_HEMP_PLACED = PlacementUtils.register("immersiveengineering_wild_hemp_placed",
            ImmersiveEngineeringConfiguredFeatures.IMMERSIVEENGINEERING_WILD_HEMP_CONFIG, RarityFilter.onAverageOnceEvery(HEMP_FREQUENCY_IMMERSIVEENINEERING),
