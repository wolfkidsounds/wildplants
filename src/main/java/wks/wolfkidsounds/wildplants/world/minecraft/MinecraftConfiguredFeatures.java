...
public class MinecraftConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> MINECRAFT_WILD_WHEAT_CONFIG = Feature.RANDOM_PATCH.withConfiguration((
    ...
    public static final ConfiguredFeature<?, ?> MINECRAFT_WILD_CARROTS_CONFIG = Feature.RANDOM_PATCH.withConfiguration((
    ...
    public static final ConfiguredFeature<?, ?> MINECRAFT_WILD_POTATOES_CONFIG = Feature.RANDOM_PATCH.withConfiguration((
    ...
    public static final ConfiguredFeature<?, ?> MINECRAFT_WILD_BEETROOTS_CONFIG = Feature.RANDOM_PATCH.withConfiguration((
